<!-- placeholder -->
<div class="overflow-auto" style="text-align: center; position: fixed;  top: 9%; left: 5.5%; height: 90%; width: 94.5%; ">
    ...
    <!-- <div style="display:flex; justify-content: space-between;">
        ...
        <div class="card text-center shadow" style="width: 9%;">
            <div class="card-body" style="border-top:5px solid #0033ffc3">
                <h5 class="card-title">NEW<br><br></h5>
    ...
    <!-- <div class="custom-row">
        <div class="custom-column">
            <div class="custom-card text-center shadow">
                <div class="card-body" style="border-top:5px solid blue">
                    <h5 class="card-title">TOTAL TICKETS<br><br></h5>
                    <h1 class="card-text"><b>{{ $all }}</b></h1>
                </div>
            </div>
        </div>
    ...
    <style>
        /* Define the CSS classes for responsive columns */
        .custom-row {
            display: flex;
            flex-wrap: wrap;
            justify-content: space-between;
            margin: -10px;
            /* Add negative margin to offset padding on columns */
        }

        .custom-column {
            flex-basis: calc(10% - 20px);
            /* Adjust the column width for 10 columns */
            margin: 10px;
    ...
    <div class="custom-row">
        <div class="custom-column">
            <div class="custom-card text-center shadow">
                <div class="card-body" style="border-top:5px solid blue">
                    <h5 class="card-title">TOTAL TICKETS<br></h5>
                    <h1 class="card-text"><b>{{ $all }}</b></h1>
                </div>
            </div>
        </div>
        ...
        <div class="custom-column">
            <div class="custom-card text-center shadow">
                <div class="card-body" style="border-top:5px solid #0033ff81">
                    <h5 class="card-title">OPENED<br></h5>
                    <h1 class="card-text"><b>{{ $opened }}</b></h1>
                </div>
            </div>
        </div>
        ...
        <div class="custom-column">
            <div class="custom-card text-center shadow">
                <div class="card-body" style="border-top:5px solid #15ff007e">
                    <h5 class="card-title">ONGOING <br></h5>
                    <h1 class="card-text"><b>{{ $ongoing }}</b></h1>
                </div>
            </div>
        </div>
        ...
        <div class="custom-column">
            <div class="custom-card text-center shadow">
                <div class="card-body" style="border-top:5px solid #15ff007c">
                    <h5 class="card-title">RESOURCE PENDING <br></h5>
                    <h1 class="card-text"><b>{{ $pending }}</b></h1>
                </div>
            </div>
        </div>
    ...
    <div class="custom-row">
        <div class="custom-column">
            <div class="custom-card text-center shadow">
                <div class="card-body" style="border-top:5px solid #00ff08">
                    <h5 class="card-title">RESOLVED<br></h5>
                    <h1 class="card-text"><b>{{ $resolved }}</b></h1>
                </div>
            </div>
        </div>
        ...
        <div class="custom-column">
            <div class="custom-card text-center shadow">
                <div class="card-body" style="border-top:5px solid #ff2f2f7f">
                    <h5 class="card-title">CANCELLED<br></h5>
                    <h1 class="card-text"><b>{{ $cancelled }}</b></h1>
                </div>
            </div>
        </div>
        ...
        <div class="custom-column">
            <div class="custom-card text-center shadow">
                <div class="card-body" style="border-top:5px solid #ff0000bd">
                    <h5 class="card-title">REJECTED<br></h5>
                    <h1 class="card-text"><b>{{ $rejected }}</b></h1>
                </div>
            </div>
        </div>
        ...
        <div class="custom-column">
            <div class="custom-card text-center shadow">
                <div class="card-body" style="border-top:5px solid #ff0000">
                    <h5 class="card-title" style="color: red">ESCALATED<br></h5>
                    <h1 class="card-text" style="color: rgba(255, 0, 0, 0.848)"><b>{{ $escalated }}</b></h1>
                </div>
            </div>
        </div>
        ...
        <div class="custom-column">
            <div class="custom-card text-center shadow">
                <div class="card-body" style="border-top:5px solid #ff0000">
                    <h5 class="card-title" style="color: rgb(163, 0, 0)">OVERDUE<br></h5>
                    <h1 class="card-text" style="color: rgb(144, 0, 0)"><b>{{ $overdue }}</b></h1>
                </div>
            </div>
        </div>
    ...
    <style>
        ...
        .custom-column {
            flex-basis: calc(20% - 20px);
            /* Default column width for larger screens */
            margin: 10px;
            /* Add padding between columns */
            box-sizing: border-box;
            /* Ensure padding is included in the column width */
        ...
        <!-- <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
            <script type="text/javascript">
                ...
                function drawChart() {
                    ...
                    var chartContainer = document.getElementById('daily');

                    // Set the initial size of the chart.
                    chartContainer.style.width = '100%';
                    chartContainer.style.height = '400px'; // Adjust the initial height as needed.
...
<div class="mt-4 d-flex flex-wrap justify-content-between">
        ...
        {{-- most issue --}}
        <!-- <div class="card mb-2 shadow" style="flex-basis: calc(40% - 10px); flex-grow: 0; padding: 5px;">
            <div class="card text-center shadow" style="height: 185px;">
                <div class="card-body">
                    <h5 class="card-title mb-5" style="color: rgba(248, 198, 0, 0.875)">MOST REPORTED ISSUE</h5>
                    <h2 class="card-text" style="color: #b99400"><b>INC#{{ $mostViewTix }}</b></h2>
                </div>
            </div>
            <div class="card text-center shadow" style="height: 185px; margin-top: 7px;">
                <div class="card-body">
                    <h5 class="card-title mb-5" style="color: rgb(255, 132, 0)"># OF VIEWS</h5>
        ...
        <div class="card mb-2 shadow" style="flex-basis: calc(40% - 10px); flex-grow: 0; padding: 5px;">
            <div class="card text-center shadow" style="height: 185px;">
                <div class="card-body">
                    <h5 class="card-title mb-5" style="color: rgba(248, 198, 0, 0.875)">MOST VIEWED KB</h5>
                    <h2 class="card-text" style="color: rgb(185, 148, 0)"><b>KBID#{{ $mostViewKB }}</b></h2>
                </div>
            </div>
            <div class="card text-center shadow" style="height: 185px; margin-top: 7px;">
                <div class="card-body">
        ...
        <div class="card mb-2 shadow" style="flex-basis: calc(20% - 10px); flex-grow: 0; padding: 5px;">
            ...
            <div class="card text-center shadow" style="height:187.5px;margin-top:7px">
                <div class="card-body">
                    <h5 class="card-title" style="color: rgb(0, 76, 255)">ACTIVE STAFF<br><br></h5>
                    <h1 class="card-text" style="color: rgb(0, 76, 255)"><i class="bi bi-person-fill"></i><b>{{ $staffCount }}</b>
                    </h1>
                </div>
            </div>
        </div> -->
        <div class="container">
            <div class="row" >
                <div class="col-md-6 col-lg-4 mb-3">
                    ...
                    <div class="card text-center shadow mt-3" style="height: 185px;">
                        <div class="card-body">
                            <h5 class="card-title mb-5" style="color: rgb(255, 132, 0)"># OF VIEWS</h5>
                            <h1 class="card-text" style="color: rgb(255, 132, 0)"><b>{{ $views }}</b></h1>
                        </div>
                ...
                <div class="col-md-12 col-lg-4 mb-3">
                    <div class="card text-center shadow" style="height: 187.5px;">
                        <div class="card-body">
                            <h5 class="card-title" style="color: rgba(0, 105, 198, 0.724)">ACTIVE CLIENTS<br><br></h5>
                            <h1 class="card-text" style="color: rgba(0, 105, 198, 0.724)"><b><i class="bi bi-person-fill"></i>{{ $userCount }}</b></h1>
                        </div>
                    </div>
                    <div class="card text-center shadow mt-3" style="height: 187.5px;">
                        <div class="card-body">
                            <h5 class="card-title" style="color: rgb(0, 76, 255)">ACTIVE STAFF<br><br></h5>
                            <h1 class="card-text" style="color: rgb(0, 76, 255)"><i class="bi bi-person-fill"></i><b>{{ $staffCount }}</b></h1>
                        </div>
                    </div>
                </div>
            </div>
...
{{-- chart --}}
    <!-- <div class="card text-center shadow" style="width: 65%;">
            <div class="card-body">
                <div class="row" style="width:40%px; background-color:white; margin-left: 0%">
        ...
        <div class="row">
            ...
            <div class="col-12 col-xl-4 mt-2">
                ...
                <button type="button" class="btn btn-outline-danger btn-sm" onclick="showChart('weekly')"><i
                        class="bi bi-calendar-range"></i>
                    Weekly</button>
                <button type="button" class="btn btn-outline-warning btn-sm" onclick="showChart('monthly')"><i
                        class="bi bi-calendar-month-fill"></i>
                    Monthly</button>
                <button type="button" class="btn btn-outline-info btn-sm" onclick="showChart('yearly')"><i
                        class="bi bi-calendar-fill"></i>
                    Yearly</button>
...
{{-- staff / client --}}
    <!-- <div class="card mb-2 shadow" style="width: 10%; padding:5px; margin-top:-22.5%; margin-left:65.5%">
        <div class="card text-center shadow" style="height:187.5px">
            <div class="card-body">
                <h5 class="card-title" style="color: rgba(0, 105, 198, 0.724)">ACTIVE
                    CLIENTS<br><br>
...
<!-- {{-- donut chart --}}
    <div class="card mb-2 shadow" style="max-width: 420px;margin-top: -23%;margin-left:76%">
        <div id="donut-chart"></div>
    </div> -->
